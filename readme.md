...
![Mock Interview GIF](https://your-repository-url.com/mock-interview-animation.gif)
...
### **Database**:  
- **PostgreSQL-1** 🗃️ (Hosted on **Render**) 
- **PostgreSQL-2** 🗃️ (Hosted on **Railways**)


### **AI Services**:  
- **Grok API** 🤖 (For coding evaluation)  
- **Speech-to-Text** 🗣️ (For interview analysis)  
